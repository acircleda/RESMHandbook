...
Define One-Way WS ANOVA (*Cite Gravetter and Wallnau*)
...
Define Factorial BS ANOVA (*Cite Gravetter and Wallnau*)
...
# Use the short form of the data (DataShort) and the shapiro.test() function to check the normality 
# Must be run for each of the four groups (cells)
```{r}
