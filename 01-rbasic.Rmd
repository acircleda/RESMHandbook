...
Your adventure with R begins with downloading and installing the required software, which is free! This will first require you to install **R**, which is the underlying language and software we will be working with. R is available for Windows, Mac OS, and Linux. In general, R is not computationally intensive and should not require a large amount of RAM nor extrmeley fast processor speeds. Consult [the proper FAQ](https://cran.rstudio.com/) for your system to learn more about computing requirements.
...
Fownload and install **RStudio Desktop**, which is free. RStudio is also available for Windows, Mac and various versions of Linux.
...
Tibbles are very similar to dataframes. A a tibble, when shown in the *console* will include its data type with it (character, factor, integer, etc.). Tibbles are data objects used with the `tidyverse` set of packages ([learn more about the `tidyverse` here][Introduction to the Tidyverse])
...
**[Download the "2019 English R Community Survey Responses.csv" file.](/data/2019 English R Community Survey Responses.csv)**
...
**[Download the "2019 English R Community Survey Responses.xlsx" file.](/data/2019 English R Community Survey Responses.xlsx)**
...
**[Download the "2019 English R Community Survey Responses.sav" file.](/data/2019 English R Community Survey Responses.sav)**
...
```
If you want to quickly comment or uncomment a chunk of text, you can use the shortcut **Shift+Ctrl+C** on Windows or **Cmd+Shift+C** on Mac.
